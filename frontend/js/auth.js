...
register.addEventListener("click", async function (e) {
    ...
    try {
        ...
        if (result.success) {
            swal("Welcome!", "Registration successful. You can now login.", "success").then(() => {
                loginForm.style.display = "flex";
                signinForm.style.display = "none";
                showSignup.classList.remove("active");
                showLogin.classList.add("active");
...
login.addEventListener("click", async function (e) {
    ...
    try {
        ...
        if (result.success) {
            ...
            swal("Welcome!", "Redirecting to the chat section", "success")
                .then(() => {
        ...
        loginUsernameError.innerText = "Something went wrong. Please refresh and try again.";
        console.error(err);
    }
